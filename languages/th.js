module.exports = {
    footer: "จัดการ และ รันระบบโดย Hatsune_miku_16 | Miku Music v2.0",
    ping: {
  ...
  help: {
    embed: {
        ...
        author: "ผู้ช่วยประจำตัวของ {botName}",
        description: `
        **ยินดีต้อนรับเหล่าแฟนคลับทุกท่านนะคะ หนู {botName} เองค่ะ**

        > เป็นคู่หู และ นักร้องประจำตัวของทุกๆคน
        > มาดูกัน ว่า {botName} สามารถทำอะไรได้บ้าง:
        ...
        **📡 ความล่าช้าในการเรียกคำสั่ง:** {ping}ms
        ...
        error: "❌ เกิด Error ระหว่างการเรียกคำสั่งเมนูช่วยเหลือจาก Shinono Server"
    },
